...
//        spark=new ExtentSparkReporter("target//extent//ExtentReport.html");
//        spark.loadXMLConfig(new File("\\resources\\spark-config.xml"));
//        extentReports.attachReporter(spark);
//
//        spark.config().setDocumentTitle("Reconciliation System Test Automation");
//        spark.config().setReportName("Reconciliation System Test Automation Report");
//        spark.config().setTheme(Theme.DARK);

        extentReports.attachReporter(extentHtmlReporter);

        extentHtmlReporter.config().setDocumentTitle("Reconciliation System Test Automation");
        extentHtmlReporter.config().setReportName("Reconciliation System Test Automation Report");
